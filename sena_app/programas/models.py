...
class Programa(models.Model):
    ...
    nivel_formacion = models.CharField(max_length=3, choices=nivel_formacion_choice, verbose_name="Nivel de Formación")
    modalidad = models.CharField(max_length=3, choices=modalidad_choice, default='PRE', verbose_name="Modalidad")
    ...
    estado = models.CharField(max_length=3,choices=estado_choice, default='ACT', verbose_name="Estado")
